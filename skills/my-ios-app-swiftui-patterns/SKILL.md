...
**Scope boundary:** This skill covers architecture, state ownership, composition, environment wiring, async loading, and related SwiftUI app structure patterns. Load the targeted reference files below only when the task needs those details.

## Focused References

Some focused component references are adapted from Dimillian/Skills under the MIT License; see `references/dimillian-skills-LICENSE`.

- Navigation and route ownership: `references/ui-navigationstack.md`
- Sheets and modal state: `references/ui-sheets.md`
- Deep links and URL routing: `references/ui-deeplinks.md`
- Async loading, cancellation, and debouncing: `references/ui-async-state.md`
- SwiftUI previews, fixtures, and mock environments: `references/ui-previews.md`
- Theming, Dynamic Type, and visual consistency: `references/ui-theming.md`
- Controls such as toggles, sliders, pickers, and form inputs: `references/ui-controls.md`
